...
class WeatherType {
    ...
    func getWeatherType(code:Int) -> Array<String> {
       return switch (code) {
        ...
        case 77 : ["Chute de neige","cloud.heavyrain"]
        case 80 : ["Pluie intense","cloud.heavyrain"]
        case 81 : ["Pluie intense","cloud.heavyrain"]
